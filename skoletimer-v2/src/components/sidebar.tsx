...
const navItems = [
  ...
  { href: "/dashboard/klasser", label: "Klasser", icon: GraduationCap },
  { href: "/dashboard/fag", label: "Fag", icon: BookOpen },
  { href: "/dashboard/timeplan", label: "Timeplan", icon: Calendar },
  { href: "/dashboard/timeforing", label: "Timeføring", icon: Clock },
